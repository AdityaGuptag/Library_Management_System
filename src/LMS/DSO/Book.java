...
public class Book {
    ...
    public Book(int id, String title, String subject, String author, boolean issued)    // Parameterise cons.
    {
        currentIdNumber++;
        if (id == -1) {
    ...
    public Book(int id, String title, String subject, String author)    // Constructor Overloading to maintain default setting that book is not issued
    {
        currentIdNumber++;
        if (id == -1) {
            bookID = currentIdNumber;
